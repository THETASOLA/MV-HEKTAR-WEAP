...
inputfold = "generation/layers/missile/existing/"
prefix = "modular_missiles_"

for s in second:
    img = Image.open(inputfold + prefix + "base.png")
    addimg = Image.open("generation/layers/missile/" + s + ".png")
    ...
    if file != "output":
        ...
        for m in mainList:
            if file.endswith(m+".png"):
                ...
                imgcopy = img.copy()
                addimg = Image.open("generation/layers/missile/" + main + ".png")
                imgcopy.paste(addimg, (0, 0), addimg)
